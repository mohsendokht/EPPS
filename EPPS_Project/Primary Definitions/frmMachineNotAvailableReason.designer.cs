...
{
    [DesignerGenerated()]
    public partial class frmMachineNotAvailableReason : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            _cmdExit.Location = new Point(77, 10);
            ...
            Panel1.Location = new Point(9, 98);
            Panel1.Name = "Panel1";
            ...
            // txtTitle
            // 
            _txtTitle.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left | AnchorStyles.Right;

            _txtTitle.Font = new Font("Tahoma", 8.25f, FontStyle.Regular, GraphicsUnit.Point, Conversions.ToByte(178));
            _txtTitle.Location = new Point(9, 18);
            _txtTitle.Multiline = true;
            _txtTitle.Name = "_txtTitle";
            _txtTitle.ScrollBars = ScrollBars.Vertical;
            _txtTitle.Size = new Size(301, 66);
            ...
            lblName.Location = new Point(312, 20);
            lblName.Name = "lblName";
            lblName.RightToLeft = RightToLeft.Yes;
            lblName.Size = new Size(65, 18);
            lblName.TabIndex = 6;
            lblName.Text = "عنوان علت:";
            // 
            // frmMachineNotAvailableReason
            // 
            ...
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "frmMachineNotAvailableReason";
            RightToLeft = RightToLeft.Yes;
            ShowIcon = false;
            ShowInTaskbar = false;
            StartPosition = FormStartPosition.CenterScreen;
            Text = " مشخصات علت در دسترس نبودن ماشین";
