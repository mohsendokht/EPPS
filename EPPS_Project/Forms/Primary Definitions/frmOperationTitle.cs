...
{
    public partial class frmOperationTitle
    {
        public frmOperationTitle()
        {
            InitializeComponent();
        ...
        private void cmdSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("عنوان فعالیت را وارد کنید", Module1.MessagesTitle, MessageBoxButtons.OK, MessageBoxIcon.Error, MessageBoxDefaultButton.Button1, MessageBoxOptions.RtlReading);
                txtTitle.Focus();
                return;
            }
                ...
                case (int)Module1.FormModeEnum.INSERT_MODE:
                    {
                        ...
                        string mCode = Module1.GetNewCode("Tbl_OperationsDefaultTitles", "Code").ToString();
                        try
                        {
                            if (Module1.cnProductionPlanning.State == ConnectionState.Closed)
                                Module1.cnProductionPlanning.Open();
                            ...
                            drInsert = dsProductionPlanning.Tables["Tbl_OperationsDefaultTitles"].NewRow();
                            drInsert["Code"] = mCode;
                            drInsert["Title"] = txtTitle.Text;
                            dsProductionPlanning.Tables["Tbl_OperationsDefaultTitles"].Rows.Add(drInsert);
                            SaveChanges();
                            trnInsert.Commit();
                            Close();
                        }
        ...
        private void SaveChanges()
        {
            ...
            {
                daOperationTitle.Update(dsChanges, "Tbl_OperationsDefaultTitles");
        ...
        private void CreateDataAdapterCommands()
        {
            ...
            daOperationTitle.InsertCommand = new SqlCommand("Insert Into Tbl_OperationsDefaultTitles(Code,Title) Values(@Code,@Title)", Module1.cnProductionPlanning);
            {
            ...
            daOperationTitle.UpdateCommand = new SqlCommand("Update Tbl_OperationsDefaultTitles Set Title=@Title Where Code=@Code", Module1.cnProductionPlanning);
            {
            ...
            daOperationTitle.DeleteCommand = new SqlCommand("Delete From Tbl_OperationsDefaultTitles Where Code=@Code", Module1.cnProductionPlanning);
            {
