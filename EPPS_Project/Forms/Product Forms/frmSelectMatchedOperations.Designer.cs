...
{
    [DesignerGenerated()]
    public partial class frmSelectMatchedOperations : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            _TreeView1.Size = new Size(473, 366);
            ...
            _cmdOK.Location = new Point(142, 385);
            ...
            cmdCancel.Location = new Point(14, 385);
            ...
            _cmdReloadTree.Location = new Point(441, 385);
            ...
            // 
            // frmSelectMatchedOperations
            // 
            AutoScaleDimensions = new SizeF(7.0f, 16.0f);
            AutoScaleMode = AutoScaleMode.Font;
            CancelButton = cmdCancel;
            ClientSize = new Size(483, 422);
            ...
            MaximizeBox = false;
            MinimizeBox = false;
            Name = "frmSelectMatchedOperations";
            RightToLeft = RightToLeft.Yes;
            ShowIcon = false;
            ShowInTaskbar = false;
            StartPosition = FormStartPosition.CenterScreen;
            Text = "  انتخاب عملیات های همزمان";
            Load += new EventHandler(frmSelectMatchedOperations_Load);
            ResumeLayout(false);
        }
